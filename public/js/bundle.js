...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"uploadProduct.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var uploadProduct = exports.uploadProduct = /*#__PURE__*/function () {
  ...
  return function uploadProduct(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
function addToCart(productId, quantity) {
  ...
  sendRequest(url, method, data, function (error, response) {
    if (error) {
      (0, _alerts.showAlert)("error", error.message);
    } else {
      (0, _alerts.showAlert)("success", response.message);
    }
  });
}
...
function removeCartItem(productId) {
  ...
  var method = "DELETE";
  sendRequest(url, method, null, function (error, response) {
    if (error) {
      (0, _alerts.showAlert)("error", error.message);
    } else {
      (0, _alerts.showAlert)("success", response.message);
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51PMc9YSAr4IGzYowgYMK2QU8BNrM503J43nA6DlitbMDUt3lNXkcATxz6rvdxa3pDY4XbHssigBrSvEqIHMSu6bK00AKgZfoiO');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteProduct.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.delete("/products/".concat(productId));
        case 3:
          response = _context.sent;
          (0, _alerts.showAlert)('success', 'Product has been deleted successfully!');
          window.setTimeout(function () {
            location.reload();
          }, 1500);
          _context.next = 12;
...
},{"/alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"updateProduct.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateProduct = exports.deleteProduct = void 0;
var _alerts = require("/alerts");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, productId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          response = _context.sent;
          (0, _alerts.showAlert)('success', 'Product has been updated successfully!');
          window.setTimeout(function () {
        ...
        case 8:
          ...
          _context.t0 = _context["catch"](0);
          console.log(_context.t0);
          (0, _alerts.showAlert)('error', 'Something went wrong while updating the product.');
        case 12:
        case "end":
          return _context.stop();
      }
...
exports.searchProductByName = void 0;
...
var _uploadProduct = require("./uploadProduct");
...
var uploadProductForm = document.getElementById('form-upload-product');
var addToCartBtn = document.querySelectorAll('#addToCartButton');
var deleteCartButtons = document.querySelectorAll('#delete-cart-btn');
var updateCartButtons = document.querySelectorAll('#update-cart-btn');
...
if (uploadProductForm) uploadProductForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var imageInput, imageFile, fileWithMimeType, form;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          ...
          imageInput = document.getElementById('image'); // Get the selected file
          imageFile = imageInput.files[0]; // Create a new Blob object with the file data and the MIME type 'model/gltf-binary'
          fileWithMimeType = new Blob([imageFile], {
          ...
          form.append('category', document.getElementById('category').value.toLowerCase());
          ...
          _context.prev = 11;
          _context.next = 14;
          return (0, _uploadProduct.uploadProduct)(form);
        case 14:
          _context.next = 19;
          break;
        case 16:
          ...
          console.error('Error uploading product:', _context.t0);
        case 19:
        case "end":
          return _context.stop();
      }
...
if (arBtn) arBtn.addEventListener('click', function (e) {
  try {
    e.preventDefault();
    ...
    if (modelViewer.canActivateAR) {
      ...
      alert('AR is not supported on this device or browser! Please try with another device.');
    }
  } catch (e) {
    console.log('Error: ', e);
  }
});
if (addToCartBtn) addToCartBtn.forEach(function (button) {
  return button.addEventListener('click', function (e) {
    e.preventDefault();
    var productId = this.getAttribute('data-product-id');
    var quantityInput = document.getElementById('quantityInput');
    var quantity;
    if (quantityInput) quantity = quantityInput.value;else quantity = 1;
    (0, _cart.addToCart)(productId, quantity);
  });
});
if (deleteCartButtons) deleteCartButtons.forEach(function (button) {
  return button.addEventListener('click', function (e) {
    e.preventDefault();
    var productId = e.target.getAttribute('data-product-id');
    // const quantity = parseInt(document.getElementById("quantityInput").value);
    (0, _cart.removeCartItem)(productId);
  });
});
if (updateCartButtons) updateCartButtons.forEach(function (button) {
  button.addEventListener('click', function (event) {
    var productId = event.target.getAttribute('data-product-id');
    var quantityInput = document.getElementById("quantity-".concat(productId));
    var newQuantity = quantityInput.value;
    (0, _cart.updateCartItem)(productId, newQuantity);
  });
});
...
var deleteProductBtn = document.querySelectorAll('#delete-product-btn');
if (deleteProductBtn) {
  deleteProductBtn.forEach(function (button) {
    return button.addEventListener('click', function (e) {
      ...
      (0, _deleteProduct.deleteProduct)(productId);
    });
  });
}
...
var updateProductForm = document.querySelector('#form-update-product');
if (updateProductForm) updateProductForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
    var name, category, description, price, quantity, productId;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          productId = document.getElementById('submit').dataset.productId;
          (0, _updateProduct.updateProduct)({
            name: name,
            category: category,
            quantity: quantity,
            price: price,
...
var updateURLWithFilters = function updateURLWithFilters(category, price) {
  ...
  var newURL = "/products?".concat(queryParams.toString());
  window.location.href = newURL;
};

// Category filter
var categoryBtn = document.querySelectorAll('.select-category');
if (categoryBtn) {
...
// Price range filter
var priceRangeBtn = document.querySelectorAll('.price-range');
if (priceRangeBtn) {
  priceRangeBtn.forEach(function (button) {
    return button.addEventListener('click', function (e) {
      e.preventDefault();
      var minPrice = parseInt(this.dataset.min);
      var maxPrice = parseInt(this.dataset.max);

      // Format price range as a string to be URL-encoded
      var priceFilter = "gte=".concat(minPrice, "&lte=").concat(maxPrice);
      var _getQueryParams2 = getQueryParams(),
        category = _getQueryParams2.category;
...
var hasQueryParams = function hasQueryParams() {
...
var searchProductByName = exports.searchProductByName = /*#__PURE__*/function () {
        ...
        case 0:
          try {
            ...
            window.setTimeout(function () {
              ...
              window.location.href = "/search-product/".concat(encodeURIComponent(name));
  ...
  return function searchProductByName(_x4) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (searchForm) {
    searchForm.addEventListener('submit', function (e) {
      ...
      var name = document.getElementById('search-product-name').value;
